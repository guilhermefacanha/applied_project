...
public class UtilFunctions {
	...
	public static String getMsg(String chave) {
		try {
			...
			return "Chave de mensagen não encontrada";
		}
	}
	...
	public static String getRemoverExtensaoArquivo(String name) {
		try {
			int lastIndex = name.lastIndexOf(".");
...
//	}
	...
	public static String getEnderecoAplicacao() {
	...
	public static void adicionarMsgWarn(String msg) {
		try {
			if (UtilFunctions.isListaValida(FacesContext.getCurrentInstance().getMessageList()))
	...
	public static void adicionarMsg(String msg, boolean erro) {
		try {
			if (UtilFunctions.isListaValida(FacesContext.getCurrentInstance().getMessageList()))
				FacesContext.getCurrentInstance().getMessageList().clear();
	...
	public static void adicionarMsg(String msg, boolean erro, boolean append) {
		if (!append && UtilFunctions.isListaValida(FacesContext.getCurrentInstance().getMessageList()))
			FacesContext.getCurrentInstance().getMessageList().clear();
	...
	public static void adicionarMsgFaces(String tit, String msg, boolean erro) {
		FacesMessage message = null;
		if (erro) {
			message = new FacesMessage(FacesMessage.SEVERITY_ERROR, tit, msg);
		} else {
			message = new FacesMessage(FacesMessage.SEVERITY_INFO, tit, msg);
		}

		FacesContext.getCurrentInstance().addMessage(null, message);
	}

	public static void limparMsgFaces() {

		FacesContext.getCurrentInstance().getMessageList().clear();
	}

	public static Object pegarSessao(String nome) {
		return FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get(nome);
	}

	public static void setarSessao(String nome, Object valor) {
		FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put(nome, valor);
	}

	public static void limparSessao(String nome) {
...
//	}
	...
	public static void removeFlash(String chave, Object objeto) {
		if (FacesContext.getCurrentInstance().getExternalContext().getFlash().containsKey(chave))
			FacesContext.getCurrentInstance().getExternalContext().getFlash().remove(chave);
	}

	public static boolean verificarFlash(String chave) {
		try {
			return FacesContext.getCurrentInstance().getExternalContext().getFlash().containsKey(chave);
		} catch (Exception e) {
			return false;
		}
	}

	public static Object getFlash(String chave) {
		if (FacesContext.getCurrentInstance().getExternalContext().getFlash().containsKey(chave)) {
			Object res = FacesContext.getCurrentInstance().getExternalContext().getFlash().get(chave);
	...
	public static void mensagemViva() {
	...
	public static void adicionarZipEntry(ZipOutputStream zos, String nome, long tamanho, String caminhoCompleto)
			throws IOException {
		try {
